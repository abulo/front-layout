  ...
  <div class="cms-post">
    <div class="container mx-auto pt-[1rem] md:pt-[2rem] pl-[0.5rem] pr-[0.5rem] md:pl-[0rem] md:pr-[0rem]">
      <div class="text-center mb-4">
        <div class="text-[1.5rem] font-[500]">音视频素材</div>
    ...
    <div class="container mx-auto pt-[1rem] md:pt-[2rem] pl-[0.5rem] pr-[0.5rem] md:pl-[0rem] md:pr-[0rem] grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
      <!-- audio  -->
      <div v-for="(item, index) in 4" :key="index" :val="item" class="post-item relative overflow-hidden rounded-[0.3rem] bg-(--layout-post-bg)">
        ...
        <div class="post-entry block relative overflow-hidden w-full">
          <router-link
            ...
            <div class="post-icon flex items-center justify-center text-[#fff] text-[1rem] rounded-[50%]">
              <IconifyIconOnline icon="fa-solid:music" />
            </div>
          </router-link>
        </div>
