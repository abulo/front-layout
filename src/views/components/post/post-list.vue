<template>
  <div class="container mx-auto pt-[1rem] md:pt-[2rem] pl-[0.5rem] pr-[0.5rem] md:pl-[0rem] md:pr-[0rem] grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-4">
    <div v-for="(item, index) in 10" :key="index" :val="item" class="post-item relative overflow-hidden rounded-[0.3rem] bg-(--layout-post-bg)">
      ...
      <div class="post-wrapper p-[10px]">
        <div class="post-cat flex items-center mb-[2px] md:mb-[4px] whitespace-nowrap">
          <a class="whitespace-nowrap" href="https://ripro.rizhuti.com/uncategorized">未分类</a>
          <a class="whitespace-nowrap" href="https://ripro.rizhuti.com/mediasc">音视频素材</a>
        </div>
  ...
  <div class="container mx-auto pt-[1rem] md:pt-[2rem] pl-[0.5rem] pr-[0.5rem] md:pl-[0rem] md:pr-[0rem] flex justify-center">
    <div class="block text-center">
      <div class="pl-[2.5rem] pr-[2.5rem] rounded-[50rem] load">
        <div class="flex items-center">
          <IconifyIconOnline icon="svg-spinners:pulse-3" class="mr-[0.25rem] h-[24px] w-[24px]" />
          <div>加载更多</div>
        </div>
      </div>
    </div>
