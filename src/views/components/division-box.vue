<template>
  <div class="division-box">
    <div class="container mx-auto pt-[1rem] md:pt-[2rem] pl-[0.5rem] pr-[0.5rem] md:pl-[0rem] md:pr-[0rem] grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
      <div class="division-item relative flex items-center bg-(--layout-division-bg) p-[0.5rem] rounded-[0.35rem] h-full max-md:flex-col max-md:text-center" v-for="(item, index) in 4">
